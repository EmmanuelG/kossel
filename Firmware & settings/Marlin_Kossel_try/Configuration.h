...
#define STRING_CONFIG_H_AUTHOR "(Emmanuel, KosselM)" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,80,140}  // FoldaRap direct drive Nema14, M6 leadscrew
#define DEFAULT_MAX_FEEDRATE          {250, 250, 250, 50}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {6000,6000,6000,10200}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
